...
def analyze_sentiment(transcript):
    try:
        ...
        response = model.generate_content(f"give me summary of what is being discussed in the video below 50 words and Analyze the sentiment of the following text and give output in single word one of from Positive or Negative :\n\n{transcript}")
...
st.title("📺Video sentiments Analyzer📽️")
